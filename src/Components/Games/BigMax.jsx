...
export default function BigMax({bets, setBets}) {
            ...
            <div className="left">
                <div className="left-top">
                    ...
                    <div className="left-matrix">
                        {range(game_matrix[2].big_max.clickable_numbers[0], game_matrix[2].big_max.clickable_numbers[1]).map((e, i) => (
                            <button
                        ...
                        {range(game_matrix[2].big_max.disabled_numbers[0], game_matrix[2].big_max.disabled_numbers[1]).map((e, i) => (
                ...
                <div className="left-bottom">
                    ...
                    <div className="controller">
                        <div className="left-controllers-row-one">
                            {game_matrix[2].big_max.controllers.row_one.map((e, i) => (
                                <button
                                    key={i}
                        ...
                        <div className="left-controllers-row-two">
                            {game_matrix[2].big_max.controllers.row_two.map((e, i) => {
                                if(e.name === "CANCEL") {
                                    return <button
                                    key={i}
                                    className="left-controller"
